...
AtlasResultsFolder="$9" #"${StudyFolder}/${Subject}/MNINonLinear/ASL/Results/OutputtoCIFTI"
T1wSpcResultsFolder="${10}" #"${StudyFolder}/${Subject}/T1w/ASL/Results/OutputtoCIFTI"
LowResMesh="$4" #"32" #"$3"
